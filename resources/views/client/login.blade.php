...
<div class="flex">
    <div class="w-xl w-auto-sm mx-auto py-5">
        <div class="p-4 d-flex flex-column h-100"><!-- brand --> <a href="" class="navbar-brand align-self-center">
                <svg width="32" height="32" viewBox="0 0 512 512" xmlns="http://www.w3.org/2000/svg"
                    ...
                    class="hidden-folded d-inline l-s-n-1x align-self-center">Basik</span> </a><!-- / brand --></div>
        <div class="card">
            <div id="content-body">
                <div class="p-3 p-md-5">
                    ...
                    <form class="" role="form" action="{{route('login.user')}}" method="post">
                        @csrf
                        ...
                        <div class="form-group"><label>Password</label>
                            ...
                            <div class="my-3 text-right">
                                <a href="" class="text-muted" data-pjax-state="">Forgot password?</a>
                            </div>
                        </div>
                        ...
                        <div>Do not have an account? <a href="{{route('signup.user')}}" class="text-primary"
