        ...
        <div class="row">
            <div class="col-md-12">
                <div class="main-card mb-3 card">
                    ...
                    <div class="card-body">
                        <form
                            action="@if (isset($singer)) {{ route('singer.update', $singer->id) }} @else {{ route('singer.store') }} @endif"
                            ...
                            <div class="position-relative row form-group">
                                ...
                                <div class="col-md-9 col-xl-8">
                                    <img style="height: 200px; cursor: pointer;" class="thumbnail rounded-circle"
                                        ...
                                        accept=".jpg,.jpeg,.png"
                                        src=" @if (isset($singer->image) != null) {{ asset('uploads/' . $singer->image) }}  @else {{ asset('template/admin/assets/images/add-image-icon.jpg') }} @endif"
                            ...
                            <div class="position-relative row form-group">
                                ...
                                <div class="col-md-9 col-xl-8">
                                    <input required="" name="name" id="name" placeholder="Name" type="text"
                                        ...
                                        value="@if (isset($singer)) {{ $singer->name }} @else {{ old('name') }} @endif">
                                </div>
                            </div>
                            <div class="position-relative row form-group">
                            ...
                            <div class="position-relative row form-group mb-1">
                                <div class="col-md-9 col-xl-8 offset-md-2">
                                    <a href="{{ route('singer.index') }}" class="border-0 btn btn-outline-danger mr-1">
